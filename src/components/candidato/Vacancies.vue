      ...
      <vs-row justify="space-between">
        ...
        <vs-col lg="8" sm="12" xs="12" class="space-top space">
          <div class="content-data datos text-start bg-gray">
            ...
            >
              <vs-row class="space">
                <vs-col lg="2" sm="12" xs="12" class="text-center space-top">
                  <vs-avatar color="#b13cd2" class="margin-xy">
                ...
                <vs-col lg="1" sm="12" xs="12" class="space-top">
                  <vs-row justify="space-between">
                    ...
                    <vs-col lg="12" sm="2" xs="2">
                      <vs-tooltip>
                        <vs-button icon animation-type="vertical" danger>
