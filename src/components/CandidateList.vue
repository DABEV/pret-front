      ...
      <div class="space-top content-data space datos text-start bg-gray">
        <vs-row justify="space-between">
          <vs-col lg="5" sm="12" xs="12">
            Candidatos que han aplicado para un puesto en el empleo <strong>"{{job}}"</strong>
          </vs-col>
      ...
      <div class="space-top content-data space datos text-start bg-gray">
        ...
        >
          <vs-row class="space">
            ...
            <vs-col lg="1" sm="3" xs="3" class="space-top">
              <vs-tooltip>
                <vs-button icon animation-type="rotate" color="#7d33ff">
                  <em class="bx bxs-file-pdf"></em>
                  <template #animate><em class="bx bxs-file-pdf"></em></template>
                </vs-button>
